...
params:
    seurat_file: "data/2018-05-16/bcb_filtered_high_conf_seurat.rda"
    all_markers_file: "data/2018-05-16/bcb_filtered_high_conf_seurat_markers_wilcoxon.rda"
...
```{r top_markers}
top_markers <- topMarkers(all_markers, n = 10)
top_markers
```
