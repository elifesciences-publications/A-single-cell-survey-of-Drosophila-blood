...
markers <- FindConservedMarkers(all_data, ident.1 = 10, ident.2 = 6, grouping.var = "tech", verbose = FALSE)
markers <- ann_genes(markers,rows)
markers_list_conserved[[paste0("cluster_10vs6")]] <- markers

# 8 vs 13

markers <- FindConservedMarkers(all_data, ident.1 = 8, ident.2 = 13, grouping.var = "tech", verbose = FALSE)
markers <- ann_genes(markers,rows)
markers_list_conserved[[paste0("cluster_8vs13")]] <- markers

# 14 vs 1

markers <- FindConservedMarkers(all_data, ident.1 = 14, ident.2 = 1, grouping.var = "tech", verbose = FALSE)
markers <- ann_genes(markers,rows)
